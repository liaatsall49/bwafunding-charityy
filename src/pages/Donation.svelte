...
<Header />
	...
	"background-image:url('https://lincolnshiretoday.net/mag/wp-content/uploads/2020/03/Organ-donation-scaled.jpg')">
	...
	<form on:submit|preventDefault={handleForm} action="#" method="post" id="xs-donation-form" class="xs-donation-form" name="xs-donation-form">
        ...
        <input type="text"name="name" id="xs-donate-name" class="form-control" required="true" bind:value="{amount}" placeholder="Your donation in Rupiah">
        </div><!-- .xs-input-group END -->
        
        <div class="xs-input-group">
        <label for="xs-donate-name">Your Name<span class="color-light-red">**</span></label>
        <input type="text"name="name" id="xs-donate-name" class="form-control" required="true" bind:value={name} placeholder="Your Awesome Name">
        </div>
        
        <div class="xs-input-group">
        <label for="xs-donate-name">Your Email<span class="color-light-red">**</span></label>
        <input type="email"name="email"  id="xs-donate-name" class="form-control" required="true" bind:value={email} placeholder="email@awesome.com">
        </div>
        ...
        <button type="submit" disabled="{!agree}" class="btn btn-warning"><span class="badge">
